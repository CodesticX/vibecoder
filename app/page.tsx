  ...
  return (
    <section className="flex flex-col min-h-screen bg-gradient-to-b from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900">
      ...
      <section className="mx-auto my-auto flex flex-col items-center max-w-6xl px-4 py-32 sm:py-40 text-center z-50">
        ...
        <p className="text-slate-600 dark:text-slate-400 mb-6 max-w-2xl mx-auto text-lg sm:text-xl">
        ...
        <button className="z-50 w-fit mt-6 sm:mt-8 mx-auto justify-center relative inline-flex h-12 sm:h-14 overflow-hidden rounded-full p-[1px]">
          ...
          <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-white dark:bg-slate-950 px-6 sm:px-8 py-1 text-sm sm:text-base font-medium text-slate-900 dark:text-white backdrop-blur-3xl">
            Book a Session Now
          </span>
        </button>
      </section>
      ...
      {/* Background Beams */}
      <BackgroundBeams className="mt-16 sm:mt-28 w-full md:max-w-7xl md:rounded-2xl bg-conic-180 from-indigo-400 via-indigo-50 to-indigo-400" />
